...
const ServicesContainer = () => {
  return (
    <div className="w-[1248px] h-[499px] flex flex-row items-start justify-start gap-[48px] text-center text-21xl text-black font-helvetica-now-text-">
      <div className="self-stretch relative rounded bg-off-white shadow-[0px_24px_48px_rgba(17,_24,_39,_0.25)_inset] w-96">
        ...
        <img
          className="absolute h-[156.91%] w-[219.53%] top-[-17.43%] right-[-90.36%] bottom-[-39.48%] left-[-29.17%] max-w-full overflow-hidden max-h-full"
          alt=""
